...
// signed-in workspace (/os), the login page, and non-page routes — only the
// public marketing surface (/, /pendekatan) is tracked.

const SESSION_ID_KEY = "konglo_sid";
const UTM_KEY = "konglo_utm";
